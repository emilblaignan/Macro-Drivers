...
The Q-Q plots and formal tests in Tables 8 and 9 suggest that residuals in both the basic and transformed models deviate from normality:
...
The results, summarized in Table 12, are as follows:
...
Based on the results in **Table 19: Final Model Comparison**, we select the **transformed model** as our final specification. This decision is grounded in a combination of statistical performance, diagnostic robustness, and economic interpretability. Importantly, this choice reflects a comparative evaluation across several candidate models developed throughout our analysis.
